namespace ApplicationInsightsTracer.Exceptions
{
    ...
    public class OperationNotStartedException : Exception
    {
        // Constructor form 1 ()
        /// <summary>
        /// Creates a new instance of the <see cref="OperationNotStartedException"/> class with no arguments.
        /// </summary>
        public OperationNotStartedException()
        {
        }

        // Constructor form 2 (message)
        /// <summary>
        /// Creates a new instance of the <see cref="OperationNotStartedException"/> class
        /// with a specified error message.
        /// </summary>
        /// <param name='message'>The message that explains the reason for the exception.</param>
        public OperationNotStartedException(string message)
            : base(message)
        {
        }
        ...
        public OperationNotStartedException(string message, Exception innerException)
        ...
        public OperationNotStartedException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
